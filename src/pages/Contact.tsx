    ...
    <Layout>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-start gap-3 md:gap-4 p-4 md:p-6 rounded-xl bg-secondary">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@kayadentalbydani.com" className="text-accent hover:underline text-sm md:text-base">
                      info@kayadentalbydani.com
                    </a>
                  </div>
                </div>
      ...
      <section className="py-16 bg-secondary">
        <div className="container">
          ...
          >
            {['Leominster', 'Lunenburg', 'Lancaster', 'Ayer', 'Shirley', 'Ashburnham', 'Westminster', 'Princeton', 'Gardner'].map((town) => (
              <span
                key={town}
