    ...
    >
      <div className="container">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl border border-accent/20 bg-gradient-to-br from-kaya-navy to-kaya-navy/95 p-8 md:p-12 shadow-card"
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10">
            ...
            <div className="flex-1">
              <p className="text-white/85 text-lg leading-relaxed">
                ...
                sudden toothache, a broken tooth, or simply a schedule that cannot wait.
              </p>
            </div>
